...
|--------|------|------|-------------|
| POST | `/auth/login` | Público (5 req/min) | Login → devuelve JWT + user |
...
### Reportes — `/reportes` (todos públicos)
| Método | Ruta | Descripción |
|--------|------|-------------|
| GET | `/reportes/pdf/ventas?year=` | PDF de ventas por año |
| GET | `/reportes/pdf/pedidos` | PDF de pedidos |
| GET | `/reportes/pdf/stock` | PDF de stock crítico |
| GET | `/reportes/pdf/pedidos-entregados` | PDF de pedidos entregados |
| GET | `/reportes/pdf/ganancias?month=&year=` | PDF de ganancias |
| GET | `/reportes/pdf/diario` | PDF del reporte diario |
| GET | `/reportes/excel/pedidos-entregados` | Excel pedidos entregados |
| GET | `/reportes/excel/ganancias?month=&year=` | Excel ganancias |
| GET | `/reportes/excel/pedidos` | Excel todos los pedidos |
| GET | `/reportes/excel/clientes` | Excel clientes |
| GET | `/reportes/excel/stock` | Excel stock |
| GET | `/reportes/excel/diario` | Excel reporte diario |
